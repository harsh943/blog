import { SignupInput } from "@harsh859/blog-common";
  ...
  return (
    <div className="h-screen flex justify-center flex-col">
        <div className="flex justify-center">
            ...
            <div>
            {type==="signup"?<LabelledInput label="Name" placeholder="Harsh Deep" onChange={(e)=>{
                setPostInputs({
                    ...postInputs,//existing usrname and password
                    name: e.target.value
                })
            }}/>:null}
